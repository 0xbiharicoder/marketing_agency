          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                We help businesses succeed in the digital age with cutting-edge web development, 
                mobile apps, and digital marketing solutions.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-royal-600 hover:bg-royal-700 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">SEO & SEM</a></li>
              </ul>
            </div>
