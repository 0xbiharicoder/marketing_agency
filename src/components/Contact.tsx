        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 bg-royal-100 rounded-lg flex items-center justify-center mr-4">
            ...
            <div className="bg-gradient-to-br from-royal-400 to-royal-600 rounded-2xl p-8 text-white">
              ...
              <p className="mb-6">Schedule a free consultation call to discuss your project requirements and get a custom quote.</p>
              <button className="bg-white text-royal-600 hover:bg-cream-50 font-semibold py-3 px-6 rounded-lg transition-all duration-200">
                Schedule Call
              </button>
            </div>
          </div>
